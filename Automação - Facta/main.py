...
def _load_runtime_config():
    """
    Prioridade:
    1) CLI args  (--codigo-af / --captcha-key)
    2) Variáveis de ambiente (CODIGO_AF / TWO_CAPTCHA_API_KEY)
    3) Prompt (fallback)
    """
...
if __name__ == "__main__":
    CODIGO_AF, TWO_CAPTCHA_API_KEY = _load_runtime_config()
    main(headless=False)
